...
/**
* The implementation file for type MSGraphDirectoryRoleTemplateCollectionFetcher.
*/

@implementation MSGraphDirectoryRoleTemplateCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphDirectoryRoleTemplate class]];
}
...
- (MSGraphDirectoryRoleTemplateFetcher *)getById:(NSString *)id {
    ...
    return [[MSGraphDirectoryRoleTemplateFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
