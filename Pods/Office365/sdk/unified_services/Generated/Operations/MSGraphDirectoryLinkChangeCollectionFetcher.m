...
/**
* The implementation file for type MSGraphDirectoryLinkChangeCollectionFetcher.
*/

@implementation MSGraphDirectoryLinkChangeCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphDirectoryLinkChange class]];
}
...
- (MSGraphDirectoryLinkChangeFetcher *)getById:(NSString *)id {
    ...
    return [[MSGraphDirectoryLinkChangeFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
