...
/**
* The implementation file for type MSGraphFileAttachmentCollectionFetcher.
*/

@implementation MSGraphFileAttachmentCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphFileAttachment class]];
}
...
- (MSGraphFileAttachmentFetcher *)getById:(NSString *)id {
    ...
    return [[MSGraphFileAttachmentFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
