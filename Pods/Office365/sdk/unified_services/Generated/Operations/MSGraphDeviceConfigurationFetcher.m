...
@implementation MSGraphDeviceConfigurationFetcher

@synthesize operations = _operations;

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSGraphDeviceConfiguration class]]) {

		_operations = [[MSGraphDeviceConfigurationOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }

    return self;
}

- (void)update:(id)entity callback:(void (^)(MSGraphDeviceConfiguration *deviceConfiguration, MSOrcError *e))callback {
