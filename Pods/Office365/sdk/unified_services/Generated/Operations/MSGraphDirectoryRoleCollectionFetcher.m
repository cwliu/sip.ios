...
/**
* The implementation file for type MSGraphDirectoryRoleCollectionFetcher.
*/
...
- (MSGraphDirectoryRoleFetcher *)getById:(NSString *)id {
    ...
    return [[MSGraphDirectoryRoleFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
