...
/**
* The implementation file for type MSGraphDirectoryObjectOperations.
*/
...
- (void)checkMemberGroupsWithGroupIds:(NSArray *)groupIds callback:(void (^)(NSArray *string, MSOrcError *error))callback {
	...
	return [self checkMemberGroupsRawWithGroupIds:groupIdsString callback:^(NSString *returnValue, MSOrcError *e) {
	   ...
	   if (e == nil) {
			...
			NSArray * result = (NSArray *)[super.resolver.jsonSerializer deserialize:[returnValue dataUsingEncoding:NSUTF8StringEncoding] asClass:[NSString class]];
            callback(result, e);
        } 
		else {
...
- (void)getMemberGroupsWithSecurityEnabledOnly:(BOOL)securityEnabledOnly callback:(void (^)(NSArray *string, MSOrcError *error))callback {
...
- (void)getMemberObjectsWithSecurityEnabledOnly:(BOOL)securityEnabledOnly callback:(void (^)(NSArray *string, MSOrcError *error))callback {
