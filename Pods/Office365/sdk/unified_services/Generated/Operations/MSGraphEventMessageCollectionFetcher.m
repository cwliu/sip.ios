...
/**
* The implementation file for type MSGraphEventMessageCollectionFetcher.
*/
...
- (MSGraphEventMessageFetcher *)getById:(NSString *)id {
    ...
    return [[MSGraphEventMessageFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
