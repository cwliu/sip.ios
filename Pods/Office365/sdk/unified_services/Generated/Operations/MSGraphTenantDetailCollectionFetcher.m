...
/**
* The implementation file for type MSGraphTenantDetailCollectionFetcher.
*/
...
- (MSGraphTenantDetailFetcher *)getById:(NSString *)id {
    ...
    return [[MSGraphTenantDetailFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
