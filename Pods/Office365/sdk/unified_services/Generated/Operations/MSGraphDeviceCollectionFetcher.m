...
/**
* The implementation file for type MSGraphDeviceCollectionFetcher.
*/
...
- (MSGraphDeviceFetcher *)getById:(NSString *)id {
    ...
    return [[MSGraphDeviceFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
