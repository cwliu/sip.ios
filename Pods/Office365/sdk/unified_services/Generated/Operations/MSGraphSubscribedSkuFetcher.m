...
@implementation MSGraphSubscribedSkuFetcher

@synthesize operations = _operations;

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSGraphSubscribedSku class]]) {

		_operations = [[MSGraphSubscribedSkuOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }

    return self;
}

- (void)update:(id)entity callback:(void (^)(MSGraphSubscribedSku *subscribedSku, MSOrcError *e))callback {
