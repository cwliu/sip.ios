...
@implementation MSGraphAppRoleAssignmentFetcher

@synthesize operations = _operations;

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSGraphAppRoleAssignment class]]) {

		_operations = [[MSGraphAppRoleAssignmentOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }

    return self;
}

- (void)update:(id)entity callback:(void (^)(MSGraphAppRoleAssignment *appRoleAssignment, MSOrcError *e))callback {
