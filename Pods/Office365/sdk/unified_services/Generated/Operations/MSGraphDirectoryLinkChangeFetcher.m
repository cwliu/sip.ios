...
@implementation MSGraphDirectoryLinkChangeFetcher

@synthesize operations = _operations;

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSGraphDirectoryLinkChange class]]) {

		_operations = [[MSGraphDirectoryLinkChangeOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }

    return self;
}

- (void)update:(id)entity callback:(void (^)(MSGraphDirectoryLinkChange *directoryLinkChange, MSOrcError *e))callback {
