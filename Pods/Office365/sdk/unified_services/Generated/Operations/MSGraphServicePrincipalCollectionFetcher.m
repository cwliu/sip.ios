...
/**
* The implementation file for type MSGraphServicePrincipalCollectionFetcher.
*/

@implementation MSGraphServicePrincipalCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphServicePrincipal class]];
}
...
- (MSGraphServicePrincipalFetcher *)getById:(NSString *)id {
    ...
    return [[MSGraphServicePrincipalFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
