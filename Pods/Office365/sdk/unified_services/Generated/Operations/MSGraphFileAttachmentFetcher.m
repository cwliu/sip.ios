...
@implementation MSGraphFileAttachmentFetcher

@synthesize operations = _operations;

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSGraphFileAttachment class]]) {

		_operations = [[MSGraphFileAttachmentOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }

    return self;
}

- (void)update:(id)entity callback:(void (^)(MSGraphFileAttachment *fileAttachment, MSOrcError *e))callback {
