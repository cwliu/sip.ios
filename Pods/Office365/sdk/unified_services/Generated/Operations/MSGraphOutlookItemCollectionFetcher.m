...
/**
* The implementation file for type MSGraphOutlookItemCollectionFetcher.
*/

@implementation MSGraphOutlookItemCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSGraphOutlookItem class]];
}
...
- (MSGraphOutlookItemFetcher *)getById:(NSString *)id {
    ...
    return [[MSGraphOutlookItemFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
