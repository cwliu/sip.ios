...
/**
* The implementation file for type MSGraphOAuth2PermissionGrantCollectionFetcher.
*/
...
- (MSGraphOAuth2PermissionGrantFetcher *)getById:(NSString *)id {
    ...
    return [[MSGraphOAuth2PermissionGrantFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
