...
- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {
    ...
    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSGraphReferenceAttachment class]]) {

		_operations = [[MSGraphReferenceAttachmentOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }
