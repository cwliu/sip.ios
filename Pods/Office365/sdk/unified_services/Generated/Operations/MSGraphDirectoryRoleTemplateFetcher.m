...
@implementation MSGraphDirectoryRoleTemplateFetcher

@synthesize operations = _operations;

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSGraphDirectoryRoleTemplate class]]) {

		_operations = [[MSGraphDirectoryRoleTemplateOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }

    return self;
}

- (void)update:(id)entity callback:(void (^)(MSGraphDirectoryRoleTemplate *directoryRoleTemplate, MSOrcError *e))callback {
