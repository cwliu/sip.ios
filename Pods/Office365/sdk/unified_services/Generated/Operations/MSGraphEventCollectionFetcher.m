...
/**
* The implementation file for type MSGraphEventCollectionFetcher.
*/
...
- (MSGraphEventFetcher *)getById:(NSString *)id {
    ...
    return [[MSGraphEventFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
