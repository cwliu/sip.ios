...
- (void)update:(id)entity callback:(void (^)(MSGraphDevice *device, MSOrcError *e))callback {
...
- (MSGraphDirectoryObjectCollectionFetcher *)registeredOwners {
...
- (MSGraphDirectoryObjectFetcher *)getRegisteredOwnersById:(NSString *)id {
    ...
    return [[[MSGraphDirectoryObjectCollectionFetcher alloc] initWithUrl:@"registeredOwners" parent:self asClass:[MSGraphDirectoryObject class]] getById:id];
}

- (MSGraphDirectoryObjectCollectionFetcher *)registeredUsers {
...
- (MSGraphDirectoryObjectFetcher *)getRegisteredUsersById:(NSString *)id {
    ...
    return [[[MSGraphDirectoryObjectCollectionFetcher alloc] initWithUrl:@"registeredUsers" parent:self asClass:[MSGraphDirectoryObject class]] getById:id];
}
