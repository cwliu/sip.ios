...
@implementation MSGraphOAuth2PermissionGrantFetcher

@synthesize operations = _operations;

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSGraphOAuth2PermissionGrant class]]) {

		_operations = [[MSGraphOAuth2PermissionGrantOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }

    return self;
}

- (void)update:(id)entity callback:(void (^)(MSGraphOAuth2PermissionGrant *oAuth2PermissionGrant, MSOrcError *e))callback {
