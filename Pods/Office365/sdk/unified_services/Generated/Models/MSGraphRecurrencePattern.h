...
@property (copy, nonatomic, readwrite, getter=daysOfWeek, setter=setDaysOfWeek:) NSMutableArray *DaysOfWeek;
@property  (nonatomic, getter=firstDayOfWeek, setter=setFirstDayOfWeek:) MSGraphDayOfWeek FirstDayOfWeek;
- (void)setFirstDayOfWeekString:(NSString *)value;
@property  (nonatomic, getter=index, setter=setIndex:) MSGraphWeekIndex Index;
