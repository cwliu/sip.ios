...
@property (copy, nonatomic, readwrite, getter=owner, setter=setOwner:) MSGraphIdentity *owner;
@property (copy, nonatomic, readwrite, getter=quota, setter=setQuota:) MSGraphDriveQuota *quota;
