...
@property (copy, nonatomic, readwrite, getter=emailAddress, setter=setEmailAddress:) MSGraphEmailAddress *EmailAddress;
@property (copy, nonatomic, readwrite, getter=status, setter=setStatus:) MSGraphResponseStatus *Status;
