...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_alternativeSecurityIds = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphAlternativeSecurityId"];
		_devicePhysicalIds = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphString"];
		_registeredOwners = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphDirectoryObject"];
		_registeredUsers = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphDirectoryObject"];
    }
