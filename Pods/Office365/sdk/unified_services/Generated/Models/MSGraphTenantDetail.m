...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_marketingNotificationEmails = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphString"];
		...
		_securityComplianceNotificationMails = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphString"];
		_securityComplianceNotificationPhones = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphString"];
		_technicalNotificationMails = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphString"];
		_verifiedDomains = [[NSMutableArray alloc] initWithCollectionType:@"MSGraphVerifiedDomain"];
    }
