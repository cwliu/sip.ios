...
@interface MSSharePointDrive : MSOrcBaseEntity

@property (copy, nonatomic, readwrite, getter=id, setter=setId:) NSString *id;
@property (copy, nonatomic, readwrite, getter=owner, setter=setOwner:) MSSharePointIdentity *owner;
@property (copy, nonatomic, readwrite, getter=quota, setter=setQuota:) MSSharePointDriveQuota *quota;
