...
- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {
    ...
    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSDirectoryDirectoryLinkChange class]]) {

		_operations = [[MSDirectoryDirectoryLinkChangeOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }

    return self;
}

- (void)update:(id)entity callback:(void (^)(MSDirectoryDirectoryLinkChange *directoryLinkChange, MSOrcError *e))callback {
