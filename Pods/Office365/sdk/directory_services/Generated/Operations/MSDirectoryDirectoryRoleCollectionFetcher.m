...
- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {
    ...
    return [super initWithUrl:urlComponent parent:parent asClass:[MSDirectoryDirectoryRole class]];
}
...
- (MSDirectoryDirectoryRoleFetcher *)getById:(NSString *)id {
    ...
    return [[MSDirectoryDirectoryRoleFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
