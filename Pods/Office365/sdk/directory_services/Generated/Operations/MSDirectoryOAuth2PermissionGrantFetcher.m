...
- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {
    ...
    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSDirectoryOAuth2PermissionGrant class]]) {

		_operations = [[MSDirectoryOAuth2PermissionGrantOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }

    return self;
}

- (void)update:(id)entity callback:(void (^)(MSDirectoryOAuth2PermissionGrant *oAuth2PermissionGrant, MSOrcError *e))callback {
