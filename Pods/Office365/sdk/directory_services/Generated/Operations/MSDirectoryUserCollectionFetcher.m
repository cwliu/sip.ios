...
- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {
    ...
    return [super initWithUrl:urlComponent parent:parent asClass:[MSDirectoryUser class]];
}
...
- (MSDirectoryUserFetcher *)getById:(NSString *)id {
    ...
    return [[MSDirectoryUserFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
