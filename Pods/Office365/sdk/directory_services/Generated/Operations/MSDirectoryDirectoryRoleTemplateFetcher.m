...
- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {
    ...
    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSDirectoryDirectoryRoleTemplate class]]) {

		_operations = [[MSDirectoryDirectoryRoleTemplateOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }

    return self;
}

- (void)update:(id)entity callback:(void (^)(MSDirectoryDirectoryRoleTemplate *directoryRoleTemplate, MSOrcError *e))callback {
