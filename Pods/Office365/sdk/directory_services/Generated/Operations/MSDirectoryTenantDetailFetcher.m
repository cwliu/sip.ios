...
- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {
    ...
    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSDirectoryTenantDetail class]]) {

		_operations = [[MSDirectoryTenantDetailOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }

    return self;
}

- (void)update:(id)entity callback:(void (^)(MSDirectoryTenantDetail *tenantDetail, MSOrcError *e))callback {
