...
- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {
    ...
    if (self = [super initWithUrl:urlComponent parent:parent asClass:[MSDirectoryAppRoleAssignment class]]) {

		_operations = [[MSDirectoryAppRoleAssignmentOperations alloc] initOperationWithUrl:urlComponent parent:parent];
    }

    return self;
}

- (void)update:(id)entity callback:(void (^)(MSDirectoryAppRoleAssignment *appRoleAssignment, MSOrcError *e))callback {
