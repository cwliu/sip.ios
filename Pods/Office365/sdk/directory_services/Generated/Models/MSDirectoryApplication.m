...
/**
* The implementation file for type MSDirectoryApplication.
*/

@implementation MSDirectoryApplication	
...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_identifierUris = [[NSMutableArray alloc] initWithCollectionType:@"MSDirectoryString"];
		_keyCredentials = [[NSMutableArray alloc] initWithCollectionType:@"MSDirectoryKeyCredential"];
		_knownClientApplications = [[NSMutableArray alloc] initWithCollectionType:@"MSDirectoryGuid"];
		...
		_requiredResourceAccess = [[NSMutableArray alloc] initWithCollectionType:@"MSDirectoryRequiredResourceAccess"];
		_extensionProperties = [[NSMutableArray alloc] initWithCollectionType:@"MSDirectoryExtensionProperty"];
    }
