...
/**
* The implementation file for type MSDirectoryDevice.
*/

@implementation MSDirectoryDevice	
...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_alternativeSecurityIds = [[NSMutableArray alloc] initWithCollectionType:@"MSDirectoryAlternativeSecurityId"];
		_devicePhysicalIds = [[NSMutableArray alloc] initWithCollectionType:@"MSDirectoryString"];
		_registeredOwners = [[NSMutableArray alloc] initWithCollectionType:@"MSDirectoryDirectoryObject"];
		_registeredUsers = [[NSMutableArray alloc] initWithCollectionType:@"MSDirectoryDirectoryObject"];
    }
