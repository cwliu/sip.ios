...
/**
* The implementation file for type MSDirectoryDeviceConfiguration.
*/

@implementation MSDirectoryDeviceConfiguration	
...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_publicIssuerCertificates = [[NSMutableArray alloc] initWithCollectionType:@"MSDirectoryBinary"];
		_cloudPublicIssuerCertificates = [[NSMutableArray alloc] initWithCollectionType:@"MSDirectoryBinary"];
    }
