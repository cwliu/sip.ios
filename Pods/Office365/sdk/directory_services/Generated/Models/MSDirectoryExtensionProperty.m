...
/**
* The implementation file for type MSDirectoryExtensionProperty.
*/

@implementation MSDirectoryExtensionProperty	
...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_targetObjects = [[NSMutableArray alloc] initWithCollectionType:@"MSDirectoryString"];
    }
