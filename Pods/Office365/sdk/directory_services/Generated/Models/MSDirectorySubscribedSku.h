...
@interface MSDirectorySubscribedSku : MSOrcBaseEntity
...
@property (copy, nonatomic, readwrite, getter=prepaidUnits, setter=setPrepaidUnits:) MSDirectoryLicenseUnitsDetail *prepaidUnits;
