...
- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {
    ...
    return [super initWithUrl:urlComponent parent:parent asClass:[MSOutlookContact class]];
}
...
- (MSOutlookContactFetcher *)getById:(NSString *)id {
    ...
    return [[MSOutlookContactFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
