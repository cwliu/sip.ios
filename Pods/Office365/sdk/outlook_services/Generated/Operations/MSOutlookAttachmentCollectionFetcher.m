...
- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {
    ...
    return [super initWithUrl:urlComponent parent:parent asClass:[MSOutlookAttachment class]];
}
...
- (MSOutlookAttachmentFetcher *)getById:(NSString *)id {
    ...
    return [[MSOutlookAttachmentFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
