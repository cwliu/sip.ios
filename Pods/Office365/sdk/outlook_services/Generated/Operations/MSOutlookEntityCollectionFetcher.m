...
- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {
    ...
    return [super initWithUrl:urlComponent parent:parent asClass:[MSOutlookEntity class]];
}
...
- (MSOutlookEntityFetcher *)getById:(NSString *)id {
    ...
    return [[MSOutlookEntityFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
