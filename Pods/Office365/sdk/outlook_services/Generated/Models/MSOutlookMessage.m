...
- (instancetype)init {
	...
	if (self = [super init]) {
		...
		_toRecipients = [[NSMutableArray alloc] initWithCollectionType:@"MSOutlookRecipient"];
		_ccRecipients = [[NSMutableArray alloc] initWithCollectionType:@"MSOutlookRecipient"];
		_bccRecipients = [[NSMutableArray alloc] initWithCollectionType:@"MSOutlookRecipient"];
		_replyTo = [[NSMutableArray alloc] initWithCollectionType:@"MSOutlookRecipient"];
