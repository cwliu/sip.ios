...
- (void)setContentTypeString:(NSString *)value {
	...
	if ([value isEqualToString:@"Text"]) {
		...
		_contentType = MSOutlook_BodyType_Text;
        [self valueChangedForInt:MSOutlook_BodyType_Text forProperty:@"ContentType"];
	}

	if ([value isEqualToString:@"HTML"]) {

		_contentType = MSOutlook_BodyType_HTML;
        [self valueChangedForInt:MSOutlook_BodyType_HTML forProperty:@"ContentType"];
	}
}
