...
- (void)setMeetingMessageTypeString:(NSString *)value {
	...
	if ([value isEqualToString:@"None"]) {	
        ...
        [self valueChangedForInt:MSOutlook_MeetingMessageType_None forProperty:@"MeetingMessageType"];
	}

	if ([value isEqualToString:@"MeetingRequest"]) {	

		_meetingMessageType  = MSOutlook_MeetingMessageType_MeetingRequest;
        [self valueChangedForInt:MSOutlook_MeetingMessageType_MeetingRequest forProperty:@"MeetingMessageType"];
	}

	if ([value isEqualToString:@"MeetingCancelled"]) {	

		_meetingMessageType  = MSOutlook_MeetingMessageType_MeetingCancelled;
        [self valueChangedForInt:MSOutlook_MeetingMessageType_MeetingCancelled forProperty:@"MeetingMessageType"];
	}

	if ([value isEqualToString:@"MeetingAccepted"]) {	

		_meetingMessageType  = MSOutlook_MeetingMessageType_MeetingAccepted;
        [self valueChangedForInt:MSOutlook_MeetingMessageType_MeetingAccepted forProperty:@"MeetingMessageType"];
	}
	...
	if ([value isEqualToString:@"MeetingTenativelyAccepted"]) {	
        ...
        [self valueChangedForInt:MSOutlook_MeetingMessageType_MeetingTenativelyAccepted forProperty:@"MeetingMessageType"];
	}

	if ([value isEqualToString:@"MeetingDeclined"]) {	

		_meetingMessageType  = MSOutlook_MeetingMessageType_MeetingDeclined;
        [self valueChangedForInt:MSOutlook_MeetingMessageType_MeetingDeclined forProperty:@"MeetingMessageType"];
	}
}
