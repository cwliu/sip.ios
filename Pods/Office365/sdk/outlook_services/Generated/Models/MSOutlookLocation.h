...
@property (copy, nonatomic, readwrite, getter=address, setter=setAddress:) MSOutlookPhysicalAddress *Address;
@property (copy, nonatomic, readwrite, getter=coordinates, setter=setCoordinates:) MSOutlookGeoCoordinates *Coordinates;
