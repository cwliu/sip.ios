...
- (MSOneNoteSiteCollectionCollectionFetcher *)siteCollections {

    return [[MSOneNoteSiteCollectionCollectionFetcher alloc] initWithUrl:@"siteCollections" parent:self asClass:[MSOneNoteSiteCollection class]];
}

- (MSOneNoteSiteCollectionFetcher *)getSiteCollectionsById:(NSString *)id {

    return [[[MSOneNoteSiteCollectionCollectionFetcher alloc] initWithUrl:@"siteCollections" parent:self asClass:[MSOneNoteSiteCollection class]] getById:id];
}
