...
/**
* The implementation file for type MSOneNoteSectionGroupCollectionFetcher.
*/
...
- (MSOneNoteSectionGroupFetcher *)getById:(NSString *)id {
    ...
    return [[MSOneNoteSectionGroupFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
