...
/**
* The implementation file for type MSOneNoteSiteCollectionCollectionFetcher.
*/

@implementation MSOneNoteSiteCollectionCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSOneNoteSiteCollection class]];
}
...
- (MSOneNoteSiteCollectionFetcher *)getById:(NSString *)id {
    ...
    return [[MSOneNoteSiteCollectionFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
