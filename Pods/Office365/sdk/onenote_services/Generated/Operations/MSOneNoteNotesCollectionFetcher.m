...
/**
* The implementation file for type MSOneNoteNotesCollectionFetcher.
*/
...
- (MSOneNoteNotesFetcher *)getById:(NSString *)id {
    ...
    return [[MSOneNoteNotesFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" ,id] parent:self];
}
