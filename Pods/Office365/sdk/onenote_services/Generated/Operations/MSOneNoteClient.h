...
@property (retain, nonatomic, readonly, getter=me) MSOneNoteMeFetcher *me;
@property (retain, nonatomic, readonly, getter=myOrganization) MSOneNoteMyOrganizationFetcher *myOrganization;
@end