...
@interface MSGraphAudio : MSObject
	...
	@property (nonatomic, setter=setAlbum:, getter=album) NSString* album;
		@property (nonatomic, setter=setAlbumArtist:, getter=albumArtist) NSString* albumArtist;
		@property (nonatomic, setter=setArtist:, getter=artist) NSString* artist;
		@property (nonatomic, setter=setBitrate:, getter=bitrate) int64_t bitrate;
		@property (nonatomic, setter=setComposers:, getter=composers) NSString* composers;
		@property (nonatomic, setter=setCopyright:, getter=getCopyright) NSString* copyright;
		...
		@property (nonatomic, setter=setGenre:, getter=genre) NSString* genre;
